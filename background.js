chrome.extension.onMessage.addListener(
  function(request, sender, sendResponse) {
    if (request.name == "fetchPage") {
        ...
        xhr.open('GET', "https://www.googleapis.com/youtube/v3/videos?id=" + request.videoid + "&part=snippet,contentDetails,statistics&key=AIzaSyC1KGJIDRhOu6vstiQWmESDHb7DD_HlQgA", true);
